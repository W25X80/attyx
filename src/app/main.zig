...
// Agent dashboard stubs (terminal.zig provides the real implementations)
export var g_agent_dashboard_active: i32 = 0;
export var g_toggle_agent_dashboard: i32 = 0;
