...
// Tab picker: input thread -> PTY thread (Zig-side)
...
void attyx_picker_cmd(int cmd);  // 1=bs 7=esc 8=enter 9=up 10=down 11=ctrl_r 12=ctrl_x 13=ctrl_u 14=ctrl_d 15=ctrl_w
...
// Dispatch an action on the pane at the given grid position (for context menus).
void attyx_context_menu_action(uint8_t action_id, int col, int row);
